...
|---|---:|---:|---:|---:|---|
| `case_001` | 47.2% | 95 | 10 | 8 | boundary_wrong=5, outside_gt_line=60, wrong_line=30 |
| `case_004` | 58.3% | 75 | 9 | 4 | outside_gt_line=71, wrong_line=4 |
...
|---|---:|---:|---:|---|---:|---:|
| `case_004` | 50 | 80 | 30 | `outside_gt_line` | 2 | __no_match__ |
| `case_002` | 1 | 29 | 28 | `wrong_line` | 2 | 7 |
| `case_004` | 80 | 101 | 21 | `outside_gt_line` | null | __no_match__ |
| `case_001` | 10 | 30 | 20 | `outside_gt_line` | 6 | __no_match__ |
| `case_003` | 140 | 160 | 20 | `wrong_line` | 2 | 5 |
| `case_005` | 1 | 20 | 19 | `wrong_line` | 1 | 2 |
| `case_004` | 101 | 118 | 17 | `outside_gt_line` | 6 | __no_match__ |
| `case_005` | 146 | 160 | 14 | `wrong_line` | 6 | 5 |
| `case_001` | 30 | 41 | 11 | `wrong_line` | 6 | 3 |
| `case_002` | 79 | 90 | 11 | `wrong_line` | 1 | 2 |
| `case_001` | 50 | 60 | 10 | `outside_gt_line` | 1 | __no_match__ |
| `case_001` | 113 | 123 | 10 | `outside_gt_line` | 6 | __no_match__ |
...
| `case_001` | 123 | 130 | 7 | `outside_gt_line` | 3 | __no_match__ |
| `case_001` | 150 | 157 | 7 | `outside_gt_line` | 6 | __no_match__ |
...
| `case_001` | 110 | 113 | 3 | `outside_gt_line` | 2 | __no_match__ |
