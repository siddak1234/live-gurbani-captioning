...
hand-corrected GT JSONs under `eval_data/oos_v1/test/`, validated by
`make validate-oos-gt`, then `make eval-oos-loop-align`. Do not train on these
OOS recordings; they are the variance check for whether the 91.2%
